...
public class BasePasswordPolicyManagerTest {
    ...
    // @Mock
    // MinlengthPolicy minLength;

    // @Mock
    // MaxlengthPolicy maxLength;

    // @Mock
    // MinLowercasePolicy minLowercasePolicy;

    // @Mock
    // MinUppercasePolicy minUppercasePolicy;

    // @Mock
    // MinSpecialcharPolicy minSpecialCharPolicy;

    // @Mock
    // CharsNotAllowedPolicy charsNotAllowed;
    ...
    public void testRespectivePolicyMethodCalls() throws PasswordPolicyException {
        ...
        verify(customStringUtils, times(1)).getLowerCaseCharactersCount("karthikk");
        verify(customStringUtils, times(1)).containsAnyCharacter("karthikk","@$");
        verify(customStringUtils, times(1)).getUpperCaseCharactersCount("karthikk");
        verify(customStringUtils, times(1)).getSpecialCharactersCount("karthikk");

 ...
 * 
 * 
 * @RunWith(MockitoJUnitRunner.class) public class EmailServiceTest {
 * 
 * @InjectMocks EmailService emailService = new EmailServiceImpl();
 * 
 * @Mock JavaMailSender mailSender;
 * 
 * @Before public void init() { MockitoAnnotations.initMocks(this); }
 * 
 * @Test public void checkEmails() {
 * emailService.sendSimpleMessage("kr630601@dal.ca", "Reset", "Your Password");
 * // SimpleMailMessage message = new SimpleMailMessage();
 * message.setTo("kr630601@dal.ca"); message.setSubject("Reset");
 * message.setText("Your Password"); verify(mailSender, times(1)).send(message);
 * }
 * 
 * }
 */
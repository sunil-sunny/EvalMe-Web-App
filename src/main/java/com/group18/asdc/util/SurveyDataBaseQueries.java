...
public enum SurveyDataBaseQueries {
	...
	GET_ALL_SAVED_QUESTIONS(
			"select a.surveyid,a.courseid,b.surveyquestionid,b.questionid,c.logicname,b.logicvalue,a.groupsize,a.state from survey as a inner join survey_questions as b on a.surveyid=b.surveyid inner join groupingoptions as c on b.logicid=c.logicid where a.courseid=?;"),
